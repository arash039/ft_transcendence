...
`
    ...
    let paddleWidth = 15, paddleHeight = 100, ballSize = 15;
    ...
    function movePaddles() {
        ...
        if (ballSpeedX < 0 && ballX < canvas.width / 2 + (canvas.width / 2) / 2) {
            if (ballY > paddle1Y + paddleHeight / 2 && paddle1Y < canvas.height - paddleHeight) {
    ...
    function moveBall() {
        ...
        else if  (ballX <= paddleWidth && (ballY <= paddle1Y || ballY >= paddle1Y + paddleHeight)){
                score2++;
                if (score2 !== endScore)
                    resetBall();
                else
        ...
        if (ballX >= canvas.width - paddleWidth - 20) {
